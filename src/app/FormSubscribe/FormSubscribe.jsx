    ...
    return (<>
        <form onSubmit={formik.handleSubmit} className="max-w-md md:mt-8 mt-4">
            <div className="relative">
                <input onBlur={formik.handleBlur} onChange={formik.handleChange} value={formik.values.email} name='email' type="email" id="default-search" className="block w-full p-4 pe-[150px] overflow-hidden text-base text-dark-green  rounded-lg bg-white-50 focus:ring-green outline-0 shadow-lg " placeholder="Enter your email here" required />
